...
export const Popup = () => {
  ...
  return (
    <div>
      <div className="flex items-start text-slate-900 flex-col gap-2 border-b w-full h-full h-max px-5 pt-2 pb-5 text-base">
        ...
        <button
          ...
          className="font-bold text-xs text-[#007bff] underline"
        >
